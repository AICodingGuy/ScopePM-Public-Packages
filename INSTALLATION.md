...
```bash
npx @scope-pm/mcp@0.1.6 connect --api-key sk_your_api_key_here --api-url https://api.aicodingguy.com
```
...
```json
{
  "mcpServers": {
    "scopepm": {
      "command": "npx",
      "args": ["@scope-pm/mcp@0.1.6", "--api-key", "sk_your_api_key_here"]
    }
  }
}
```
...
```bash
npx @scope-pm/mcp@0.1.6 --api-key sk_your_api_key_here --api-url https://api.aicodingguy.com
```
